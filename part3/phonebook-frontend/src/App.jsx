  ...
  const addNewPerson = (event) => {
    ...
    if (
      ...
      if (
        ...
        //FIX DO NOT MUTATE STATE LOCALLY BEFORE THE SERVER CONFIRMS
        const updatedPerson = {
          ...personToUpdateNumber,
          number: newNumber,
        };
        numberService
          .updateNumber(updatedPerson.id, updatedPerson)
          .then((returnedPerson) => {
            //ACTUALLY CHANGE THE STATE WITH THE OBJECT RETURNED
            setPersons(
              persons.map((p) =>
